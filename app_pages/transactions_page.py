...
def render_transaction_management_page():
    ...
    active_tab = st.segmented_control(
        "메뉴 선택", options=tabs, key="transaction_tab_selector", label_visibility="collapsed", selection_mode="single"
    )
...
def build_transaction_page(page_cls):
    return page_cls(render_transaction_management_page, title="계좌 관리", icon="📝", url_path="transactions")
