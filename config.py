...
# -----------------------------------------------------------------------
# 순위 점수 가중치 (라이브 rankings.py + 백테스트 engine.py 공통)
# -----------------------------------------------------------------------
# 보유보너스(%)를 제외한 나머지 비중 중 '추세 몫'을 % 로 지정(0~100, 나머지는 ATH).
# 예) 50 = 추세·ATH 동일(50:50), 60 = 추세 60 : ATH 40, 70 = 추세 70 : ATH 30.
# 보유 h% 일 때 추세 = (100-h)×(ratio/100), ATH = (100-h)×(1-ratio/100). 합은 항상 100%.
SCORE_TREND_WEIGHT_RATIO = 80
