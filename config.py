...
# -----------------------------------------------------------------------
# 버킷 가드레일 기반 비중 배분 (Bucket-Guardrailed Allocation)
# -----------------------------------------------------------------------
# 버킷별 상승 점수 합계에 비례해 버킷 목표 비중을 계산합니다.
# 가드레일: 한 버킷이 과도하게 집중/소외되지 않도록 상한/하한을 설정합니다.
# 버킷 내부 종목은 계산된 버킷 비중을 1/N으로 균등 분배합니다.
BUCKET_WEIGHT_MIN = 10  # 버킷 최소 비중 10%
BUCKET_WEIGHT_MAX = 30  # 버킷 최대 비중 30%
