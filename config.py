...
# -----------------------------------------------------------------------
# 스코어 비례 비중 배분 (Score-Proportional Weight Allocation)
# -----------------------------------------------------------------------
# 모멘텀 점수에 비례해 종목별 목표 비중을 차등 부여합니다.
# 가드레일: 한 종목이 과도하게 집중/소외되지 않도록 상한/하한을 설정합니다.
WEIGHT_MIN = 0.10  # 최소 비중 10%
WEIGHT_MAX = 0.30  # 최대 비중 30%

# 리밸런싱 버퍼: 현재비중과 목표비중 차이가 이 값 미만이면 매매를 유보합니다.
# 잦은 리밸런싱으로 인한 수수료/슬리피지를 방어합니다.
REBALANCE_BUFFER = 0.02  # ±2%
