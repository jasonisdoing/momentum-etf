...
TOP_N_HOLD_OPTIONS: tuple[int, ...] = (2, 3, 4, 5, 6)
...
ENTRY_VOL_MULT_OPTIONS: tuple[float | None, ...] = (None, 1.0, 1.5, 2.0)
...
SHORT_MA_DAYS_BY_COUNTRY: dict[str, tuple[int, ...]] = {
    ...
    "us": (10, 20, 30, 50, 100, 150, 200),
    "au": (10, 20, 30, 50, 100, 150, 200),
}
LONG_MA_DAYS_BY_COUNTRY: dict[str, tuple[int, ...]] = {
    "kor": (40, 60, 90, 120, 180, 240),
