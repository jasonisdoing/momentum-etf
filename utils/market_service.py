...
def load_market_data() -> dict[str, Any]:
    ...
    if not rows:
        raise RuntimeError("ETF 마켓 캐시가 없습니다. stock_reference_meta_updater를 먼저 실행하세요.")
    ...
    normalized_rows = [
        {
            ...
            **{
            ...
            # 1주 배수 — 최근 5거래일 평균 ÷ 20일 평균(같은 배치 저장값).
            "value_mult_week": normalize_nullable_number(row.get("거래대금배수_1주")),
