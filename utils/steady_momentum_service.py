...
#
# 총수익 상위 (같은 기간 벤치마크 QQQ +275.6%)
#   순위  룩백  종목수  상한    총수익   CAGR    MDD  소르티노  교체율
#     1    4     5     3   4283.2%  71.6%  -31.5%   2.18   48.7%
#     2    4     5     5   3940.2%  69.6%  -34.1%   2.08   48.7%
#     3    4     5     4   3940.2%  69.6%  -34.1%   2.08   48.7%
#     4    4     5     2   3936.0%  69.6%  -32.0%   2.24   49.4%
#     5    6     5     5   3508.0%  66.9%  -32.1%   1.80   35.9%
#     8    4     6     4   3083.6%  63.9%  -29.3%   2.16   47.4%
#    71    5    10     4   1436.4%  47.7%  -26.1%   1.91   38.2%  ← 직전 설정
#    96    3    10     2    903.8%  39.0%  -36.2%   1.78   58.1%
#
# 1. 종목 수가 순위를 지배한다. 1~12위가 전부 5~6종목, 하위 92~96위가 전부 9~10종목이다.
#    적을수록 총수익이 크고 낙폭도 함께 깊어진다.
# 2. 룩백 3 은 뚜렷하게 나쁘다. 교체율이 55~63% 로 다른 룩백(33~49%)보다 훨씬 높은데
#    그만큼의 대가를 얻지 못한다.
# 3. 룩백 4 는 소르티노가 높고(2.0~2.3) 회전이 빠르며(44~49%), 룩백 6 은 소르티노가
#    낮지만(1.5~1.8) 회전이 느리고(33~37%) 낙폭이 얕다(-26~-29%). 성격 차이다.
# 4. **업종 상한은 사실상 무효다.** 같은 룩백·종목수 안에서 상한만 다른 조합이 서로
#    붙어 있고, 상한 4 와 5 는 값이 아예 같은 경우가 많다(2·3위, 5·6위, 17·18위).
#    5~7종목을 뽑을 때 한 업종이 4개를 넘는 일이 드물기 때문이다. 종목 수를 크게
#    잡을 때만 의미가 생긴다.
# => 4-5-3 을 쓴다. 84개월 총수익 1위이고, 상한 3 은 같은 룩백·종목수 중 낙폭이
#    가장 얕다(-31.5% vs 상한 4·5 의 -34.1%).
#
# ⚠ 한계 — 이 값은 **표본 내 최적값**이다.
