...
## 6. 자산 관리 연동 (Balance Integration)

최신 시스템에서는 단순한 수익률 계산을 넘어, 사용자가 입력한 **실제 원금과 현금 잔고**를 기반으로 포트폴리오의 상태를 관리합니다. 이를 통해 보다 정확한 '실질 수익률'과 '버킷별 배분 비중'을 대시보드에서 실시간으로 확인할 수 있습니다.
