...
웹에서 다음 기능을 사용합니다.
* `http://localhost:3000/`
* 홈 / 자산 요약 / 보유종목 / 보유종목 상세
* 계좌: 자산 관리 / 자산 현황 / 기간별 / 스냅샷 / 설정
* 정보: 시장지수 추세 / 시장 캘린더 / ETF 비교 / 한국·미국·호주 개별주 / 한국·미국 ETF / 24H 시세 / 한국 배당주
* 종목풀: 순위 / 설정 / 백테스트
* 전략: 레버리지 / 합성 / 모멘텀 / 신고가 / 포트폴리오
* 시스템: 메모 / 데이터 소스 / 테이블 / 배치
