...
const CURRENT_NOTES = [
  ...
  },
  {
    ...
    body:
      ...
      "고정 비율이 아니며, 두 전략이 같은 종목을 담으면 합산합니다. " +
  ...
  },
  {
    title: "액션",
    body:
      "목표 주수와 계좌 보유의 차이를 문턱 없이 전부 지시로 냅니다. " +
      "교체 확정분은 그 슬리브의 교체일 시가 그룹으로 묶입니다. " +
      "계좌 금액으로 백테스트를 다시 돌리지는 않습니다 — 자본이 작으면 비싼 종목을 못 사서 다른 종목이 슬롯에 " +
      "들어와 보유 종목 자체가 달라지기 때문입니다.",
  },
  {
    title: "월초 배분 복구",
    body:
                  ...
                  <div>
                    <div style={{ fontWeight: 700, marginBottom: 6 }}>
                      ...
                      <span style={{ ...hintStyle, marginLeft: 8, fontWeight: 500 }}>
                        ...
                        문턱 없이 전부 표시합니다 · 모멘텀 교체 확정분은 교체일 그룹
                      </span>
                    </div>
                    {!hasActions ? (
                      <div style={hintStyle}>
