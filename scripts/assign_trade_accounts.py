"""Assign account codes to existing trades documents.

Usage:
    python scripts/assign_trade_accounts.py
    python scripts/assign_trade_accounts.py --dry-run
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Assign account to trades")
    parser.add_argument(
        "--dry-run",
        action="store_true",
