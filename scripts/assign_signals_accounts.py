"""Assign account codes to existing signals documents.

Usage:
    python scripts/assign_signals_accounts.py
    python scripts/assign_signals_accounts.py --dry-run
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Assign account to signals")
    parser.add_argument(
        "--dry-run",
        action="store_true",
