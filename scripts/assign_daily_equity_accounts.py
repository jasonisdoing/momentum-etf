"""Assign account codes to existing daily_equities documents.

Usage:
    python scripts/assign_daily_equity_accounts.py
    python scripts/assign_daily_equity_accounts.py --dry-run
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Assign account to daily_equities")
    parser.add_argument(
        "--dry-run",
        action="store_true",
